...
from agent.src.agents.testeur_agent import TesteurAgent
...
class TesteurAgentFactory:
    ...
    def create_agent_from_role(
            ...
            agregateur: Optional[DiffAgregateurAgent] = None
    ) -> TesteurAgent:
        """
        Crée un agent de développement à partir d'une configuration de rôle
        """
        ...
        llm_provider = LLMProviderFactory.create_provider(
            ...
            structured_response_for_local_model=role_config[
                "structured_response_for_local_model"] if "structured_response_for_local_model" in role_config else ""
        ...
        # Création de l'agregateur de code
        if agregateur is None:
            agregateur = DiffAgregateurAgent(
